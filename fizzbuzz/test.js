const { fizzBuzz, fizzBuzz1, fizzBuzzTernary } = require("./index");
...
describe("FizzBuzz: ", () => {
  ...
  test("Calling fizzBuzz1 with `5` prints out 5 statements", () => {
    fizzBuzz1(5);

    expect(console.log.mock.calls.length).toEqual(5);
  });

  test("Calling fizzBuzzTernary with `5` prints out 5 statements", () => {
    fizzBuzzTernary(5);
  ...
  test("Calling fizzBuzz1 with 15 prints out the correct values", () => {
    fizzBuzz1(15);
  ...
  test("Calling fizzBuzzTernary with 15 prints out the correct values", () => {
    fizzBuzzTernary(15);
